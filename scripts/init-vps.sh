...
DEFAULT_PANEL_JAR_URL="https://github.com/MaoPaIH/dockermanager/releases/download/v0.1.0/sb-panel-0.1.0.jar"

PANEL_JAR_URL="${PANEL_JAR_URL:-$DEFAULT_PANEL_JAR_URL}"
